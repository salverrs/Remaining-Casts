...
public class RuneIds {
    ...
    static
    {
        ...
        StaffMap.put(ItemID.IBANS_STAFF, ItemID.IBANS_STAFF);
        StaffMap.put(ItemID.IBANS_STAFF_U, ItemID.IBANS_STAFF);
        StaffMap.put(ItemID.SLAYERS_STAFF, ItemID.SLAYERS_STAFF);
        StaffMap.put(ItemID.SLAYERS_STAFF_E, ItemID.SLAYERS_STAFF);
        StaffMap.put(ItemID.SARADOMIN_STAFF, ItemID.SARADOMIN_STAFF);
        StaffMap.put(ItemID.GUTHIX_STAFF, ItemID.GUTHIX_STAFF);
        StaffMap.put(ItemID.ZAMORAK_STAFF, ItemID.ZAMORAK_STAFF);
